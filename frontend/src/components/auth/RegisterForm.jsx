...
const RegisterForm = () => {  const [email, setEmail] = useState('');
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-6">        <div className="flex justify-center mb-6">
          <div className="flex items-center space-x-2">
            <MapPin className="h-8 w-8 text-primary-600" />
            <h1 className="text-2xl font-bold text-gray-900">UglyTruth</h1>
          </div>
        </div>
